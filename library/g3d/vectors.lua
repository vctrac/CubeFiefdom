...
function vectors.angle_to(a1,a2,a3, b1,b2,b3)
	local nax,nay,naz = vectors.normalize(a1,a2,a3)
	local nbx,nby,nbz = vectors.normalize(b1,b2,b3)
	local v = vectors.dotProduct(nax,nay,naz, nbx,nby,nbz)
	return math.acos(v)
end
